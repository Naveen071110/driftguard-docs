...
```http
GET /api/v1/usage
Host: bb4fd5a7.driftguard-alp.pages.dev
```
...
## Request
```bash
curl -s https://bb4fd5a7.driftguard-alp.pages.dev/api/v1/usage \
...
[POST /api/v1/check](/api-reference/checks/run) will return `402 Payment Required`
